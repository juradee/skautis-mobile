 ...
 * }
 * @psalm-type WebwingsSkautisConfig = array{
 *     base_url?: scalar|Param|null, // Kořen instance skautISu, např. https://test-is.skaut.cz // Default: "https://is.skaut.cz"
 *     app_id?: scalar|Param|null, // AppID přidělené správcem skautISu. // Default: ""
 *     mock?: bool|Param, // Místo skautISu odpovídat z fixtures - pro vývoj bez AppID. // Default: false
 *     fixture_dir?: scalar|Param|null, // Adresář s JSON fixtures; výchozí jsou ukázková data v bundlu. // Default: null
 *     timeout?: int|Param, // Timeout SOAP volání v sekundách. // Default: 30
 *     security?: array{
 *         login_route?: scalar|Param|null, // Routa, na kterou skautIS posílá POST s tokenem. // Default: "app_login"
 *         success_route?: scalar|Param|null, // Kam jít po úspěšném přihlášení, není-li uložená cílová cesta. // Default: "app_dashboard"
 *         logout_route?: scalar|Param|null, // Routa odhlášení; sem míří i vypršelý token. // Default: "app_logout"
 *         refresh_interval?: int|Param, // Jak často nejvýš prodlužovat přihlášení, v sekundách. // Default: 600
 *     },
 * }
 ...
 *     turbo?: TurboConfig,
 *     webwings_skautis?: WebwingsSkautisConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
